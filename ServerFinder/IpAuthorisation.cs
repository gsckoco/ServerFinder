...
public class IpAuthorisation : AuthorizationHandler<IpRequirement>, IAuthorizationRequirement
{
    ...
    public IpAuthorisation(IHttpContextAccessor httpContextAccessor)
    {
